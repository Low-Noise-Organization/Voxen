...
case $GRADLE_USER_HOME in
    '')
        ...
        ;;
    ?:/*)
        GRADLE_USER_HOME=$( cygpath --mixed --absolute "$GRADLE_USER_HOME" )
        ;;
esac
...
#     temporary variables to preserve quoting and then evaluate them.
#   * Put user-overridable values first.
set -- \
